...
namespace Plugin.BLE.Abstractions
{
    public abstract class AdapterBase : IAdapter
    {
        ...
        public const string AdMessage = "atticalabs-covid-trace>";
        public const string AdId = "8C443036-B927-4965-96DE-83F39C1ABA5A";
        ...
        public abstract void StartAdvertising(string id);
    }
}
